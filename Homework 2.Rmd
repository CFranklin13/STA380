...
naive_bayes_df = data.frame(cbind(naive_bayes_pred, X_test$author))

#Add column indicating whether the prediction matches the actual author
naive_bayes_df$correct = naive_bayes_df$predict.naive_bayes_model..X_test. == naive_bayes_df$X_test.author

#Print out result (number of correct/total number of predictions)
cat("Percent correct for Naive Bays:", mean(naive_bayes_df$correct))
```
...
random_forest_df = data.frame(cbind(random_forest_pred,X_test$author))

#Add column indicating whether the prediction matches the actual author
random_forest_df$correct = random_forest_df$predict.random_forest_model..newdata...X_test. == random_forest_df$X_test.author

#Print out result (number of correct/total number of predictions)
cat("Percent correct for Naive Bays:", mean(random_forest_df$correct))
```
